...
--changeset SteveZ:45555-createTable_TABLE200 context:HR_DEV labels:Jira100
...
--changeset SteveZ:45555-createTable_EMPLOYEES context:HR_DEV
...
--changeset MikeO:45556-CreatePROC_add_job_history112 endDelimiter:/ splitStatements:false runOnChange:true context:HR_DEV
...
--changeset TsviZ:45-create_table_my_test context:HR_DEV
create table
   my_test
(
    id   integer,
